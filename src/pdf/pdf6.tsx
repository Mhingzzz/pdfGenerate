...
const PageSix: React.FC = () => {
	return (
		...
		<View style={[styles.body, { marginLeft: "30px" }]}>
			{/* section 1 */}
			<View>
				...
				<View style={{ height: "250px", border: "1px", width: "250px" }}></View>
				{/* section 2 */}
				<View>
					<View style={styles.flexRow}>
						<Text>19.</Text>
					...
					<View
						style={{ height: "150px", width: "250px", border: "1px" }}
					></View>
				</View>
			</View>
			{/* content 4 to sign */}
				...
				<View style={[styles.flexRow, { justifyContent: "space-around" }]}>
					...
					<View style={[styles.space200px]}>
						<View style={styles.flexRow}>
							<Text>ลงชื่อ</Text>
							<View
								style={[styles.space150px, { borderBottom: "1px solid black" }]}
							></View>
						</View>
						<View
							style={[
