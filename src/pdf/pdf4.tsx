          ...
          <View style={[ styles.flexRow, styles.normal ,{gap:'5px' }]}>
            ...
            <div>
              ...
              <View style={[styles.flexRow]}>
                  <Text style={[styles.bold, styles.space75px]}>ผู้อุปการะคนที่ 1</Text>
              ...
              <View style={styles.flexRow}>
                ...
                <Text style={styles.space150px}>ให้การอุปการะนักศึกษาเดือนละ     {mockData.money}</Text>
                <Text>บาท</Text>
              </View>
              <View style={styles.flexRow }>
              ...
              <View style={styles.flexRow}>
                <Text style={styles.space300px}>ลักษณะที่อยู่ปัจจุบัน [บ้านของตัวเอง/บ้านเช่า/…]	</Text>
                <Text style={styles.space100px}>ค่าเช่าที่พัก        {mockData.money}</Text>
                <Text>บาท/เดือน</Text>
              </View>
              ...
              <View style={styles.flexRow}>
                ...
                <Text style={styles.space125px}>มูลค่าหนี้สินปัจจุบัน       {mockData.money}</Text>
                <Text>บาท</Text>
              </View>
              <View style={styles.flexRow}>
                <div style={styles.flexJustCenter}>
              ...
              <View>
              <Text style={styles.italic}>ญาติที่ผู้อุปการะคนที่ 1 ต้องรับภาระในการดูแล</Text>
                <View style={{marginLeft: '20px'}}>
                <View style={[styles.flexRow ]}>
                    <Text style={[styles.bold,styles.space50px ]}>
                        คนที่ 1
                    </Text>
                    <Text style={styles.space100px}>ชื่อ    {mockData.firstName}</Text>
                    <Text style={styles.space150px}>สกุล       {mockData.lastName}</Text>
            ...
            {/* section 2 */}
            <View style={[styles.flexRow]}>
                  <Text style={[styles.bold, styles.space75px]}>ผู้อุปการะคนที่ 2</Text>
                  <Text style={styles.space100px}>ชื่อ    {mockData.firstName}</Text>
                  <Text style={styles.space150px}>สกุล       {mockData.lastName}</Text>
                  <Text style={styles.space75px}>ปีเกิด       {mockData.birthYear}</Text>
                  <Text style={styles.space50px}>อายุ    {mockData.age}</Text>
